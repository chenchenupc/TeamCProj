...
protected void onCreate(Bundle savedInstanceState) {
    ...
    {    login_id=(EditText)findViewById(R.id.textView1);
        login_password=(EditText)findViewById(R.id.textView3);
        user_login_button=(Button)findViewById(R.id.button1);
        user_register_button=(Button)findViewById(R.id.button2);
        user_login_button.setOnClickListener(this);
        user_register_button.setOnClickListener(this);
        login_id.setOnFocusChangeListener(new OnFocusChangeListener()
        {
